...
public class CartSingleRestaurantAdapter extends RecyclerView.Adapter<CartSingleRestaurantAdapter.ViewHolder> {
    ...
    public CartSingleRestaurantAdapter(Context context, ArrayList<Food> list) {
        this.cartList = list;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.elegantNumberButton.setOnValueChangeListener(new ElegantNumberButton.OnValueChangeListener() {
            ...
            public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                ...
                CartSingleRestaurantOrder.order.getQuantities().set(holder.getAdapterPosition(), newValue);
    ...
    private void deleteFromCart(String foodId, int position) {
        ...
        onItemClickListener.itemDeleted(foodId, position);
    ...
    public interface OnItemClickListener {
        void calculateTotal(ArrayList<Food> returnList);

        void itemDeleted(String foodId, int position);
    }
