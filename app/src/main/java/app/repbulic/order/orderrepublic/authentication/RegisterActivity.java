...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    @BindView(R.id.reg_email) EditText editTextEmail;
    @BindView(R.id.reg_password) EditText editTextPassword;
    @BindView(R.id.reg_button) Button registerButton;
    @BindView(R.id.login_redirect)Button redirectLogin;
